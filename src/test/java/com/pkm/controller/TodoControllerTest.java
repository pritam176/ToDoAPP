...
public class TodoControllerTest {
	...
	public void addTodo() throws Exception {
		final Todo newTodo = new Todo("New todo","New Todo");
		...
		this.mockMvc.perform(post("/todos").contentType(MediaType.APPLICATION_JSON).content(newTodoJson))
				...
				.andExpect(jsonPath("$.description", equalToIgnoringCase("New todo")));
	}

	@Test
	public void updateTodo() throws Exception {
		final Todo updatedTodo = new Todo("Second todo updated","Second todo Upadted Name");
